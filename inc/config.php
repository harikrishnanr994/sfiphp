...
$one                               = new Template('SFI', '', 'assets'); // Name, version and assets folder's name

// Global Meta Data
$one->author                       = 'Jasif Kolangath';
$one->robots                       = 'noindex, nofollow';
$one->title                        = 'SFI NSSCE';
$one->description                  = 'SFI NSSCE Unit official page with online library, blog, forum and many more.';
...
// Global Color Theme
$one->theme                        = 'amethyst';       // '' for default theme or 'amethyst', 'city', 'flat', 'modern', 'smooth'
